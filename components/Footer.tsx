        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/skills" className="text-gray-400 hover:text-white transition-colors hover:translate-x-1 inline-block">
                  Skills
                </Link>
              </li>
              <li>
                <Link href="/contact" className="text-gray-400 hover:text-white transition-colors hover:translate-x-1 inline-block">
                  Contact
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li className="hover:text-white transition-colors">
                <a href="mailto:shafiqul.dev@gmail.com">shafiqul.dev@gmail.com</a>
              </li>
              <li className="hover:text-white transition-colors">
                <a href="tel:+8801941623138">+880 1941 623138</a>
              </li>
        ...
        <div className="border-t border-gray-800 pt-8 mt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-sm">
              © {currentYear} Shafiqul Islam Sakib. All rights reserved.
            </p>
